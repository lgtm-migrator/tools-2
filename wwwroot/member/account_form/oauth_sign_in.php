<details class="mt-2 px-3 py-2 border rounded-lg" id="oauth">
  <summary class="text-center small">第三方账号登录</summary>
  <div class="mt-1 px-1 pb-5 d-flex" id="oauth_sign_in">
    ...
    <button type="button" class="border-0 btn btn-sm btn-outline-secondary dropdown-toggle" data-toggle="dropdown">更多</button>
    <div class="px-1 border-0 dropdown-menu dropdown-menu-right">
