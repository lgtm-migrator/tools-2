<div class="my-2 collapse" id="oauth_sign_in">
  <div class="d-flex justify-content-between justify-content-sm-center flex-row" style="overflow-x: auto;">
...
<button class="ml-auto mt-2 btn btn-sm border d-flex align-items-center" data-toggle="collapse" data-target="#oauth_sign_in">
