...
<div id="body" hidden>
  <div class="bg-white" id="jt_header">
    <nav class="py-1 navbar navbar-expand-md navbar-light container d-flex justify-content-between align-items-center">
      ...
      <div class="collapse navbar-collapse d-md-flex justify-content-md-end" id="account">
        ...
        <div class="ml-1 ml-sm-3 btn-group" id="account_sign_out">
          <div class="btn-group">
