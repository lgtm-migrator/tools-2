...
CREATE TABLE `jt_session`  (
  ...
  `session_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'ID',
  `session_id_status` int(0) NOT NULL COMMENT 'ID的状态',
  `session_info` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `session_expires` int(0) NOT NULL COMMENT '有效期',
