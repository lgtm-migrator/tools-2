...
CREATE TABLE `answers_id_list`  (
  ...
  `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'a 试卷名称',
  `b` int(0) NULL DEFAULT NULL COMMENT 'b 录入者ID',
  `c` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT 'c 录入者昵称',
  `d` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT 'd 录入者工作单位',
  `e` int(0) NULL DEFAULT NULL COMMENT 'e 试卷总分',
  ...
  `o` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT 'o 考生信息登记 json格式',
