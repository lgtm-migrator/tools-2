        ...
        <form action="update.php">
            <div class="form-group">
                <div class="custom-file">
                    <input class="custom-file-input" type="file" name="new_qrcode_img" id="new_qrcode_img"
                           accept="image/jpeg,image/png">
                    <label class="custom-file-label" for="new_qrcode_img" data-browse="浏览">新的二维码图片</label>
                </div>
            ...
            <div class="form-group">
                <div class="input-group">
                    ...
                    <textarea class="form-control" type="text" name="lhm_manage_new_description"
                              id="lhm_manage_new_description" rows="6" cols="" wrap="soft" maxlength="150"
                              placeholder="新的灵活码介绍" required>新的灵活码介绍</textarea>
                </div>
                <div class="form-text small text-muted">提示：文字上限150个字</div>
            </div>
            <div class="form-group text-center">
                <input type="hidden" name="token" id="lhm_manage_result_token" value="">
                <input class="btn btn-sm btn-outline-success" type="submit" name="" id="lhm_manage_result_submit"
                       value="提交更新">
            </div>
        </form>
    </div>
